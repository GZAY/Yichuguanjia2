...
import com.example.yichuguanjia2.sql.imagePath2;
...
public class w_clothes2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { new BottomSheet.Builder(w_clothes2.this).title("请选择").sheet(R.menu.choose_item).listener(new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    switch (i) {
                        ...
                        case R.id.add_camera:
                            ...
                            break;
                        case R.id.add_pic:
                            Toast.makeText(w_clothes2.this, "添加图片", Toast.LENGTH_SHORT).show();
                            if (ActivityCompat.checkSelfPermission(w_clothes2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                                ActivityCompat.requestPermissions(w_clothes2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                            }
       ...
       /*
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0) { //点击图片位置为+ 0对应0张图片
                    ...
                    intent.setClass(w_clothes2.this, ImgFileListActivity.class);
        ...
        List<imagePath2> imagePaths = DataSupport.findAll(imagePath2.class);
        for(imagePath2 ip: imagePaths){
            Bitmap bm;
            bm = getBitmapFromUri(w_clothes2.this, getImageContentUri(w_clothes2.this, ip.getPath()));
        ...
        if (listfile.size()!=0 || mCameraUri!=null || !TextUtils.isEmpty(pathImage) || saveCode == 9) {
            ...
            if(resumeCode == 3){
                for(int i=0;i<listfile.size();i++) {
                    imagePath2 ip = new imagePath2();
                    ip.setId(path_id++);
                    ip.setPath(listfile.get(i));
                    ip.save();
                    bm = getBitmapFromUri(w_clothes2.this, getImageContentUri(w_clothes2.this, listfile.get(i)));
                    HashMap<String, Object> map = new HashMap<String, Object>();
                ...
                ip.save();
                bm = getBitmapFromUri(w_clothes2.this, getImageContentUri(w_clothes2.this,pathImage));
                map.put("itemImage", bm);
                imageItem.add(map);
            } else {
                HashMap<String, Object> map = new HashMap<String, Object>();
                ...
                ip.save();
                bm = getBitmapFromUri(w_clothes2.this, mCameraUri);
                map.put("itemImage", bm);
                imageItem.add(map);
            }
            resumeCode = 0;
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(w_clothes2.this);
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String pos = position + "";
                DataSupport.deleteAll(imagePath2.class,"id=?", pos);
