package com.example.yichuguanjia2.Utils;
...
public class UI_Tools {
    ...
    public void CancelFocus(final Activity activity, final List<ViewGroup> listViewGroup, final EditText edittext) {
        ...
        for (; i < listViewGroup.size(); i++) {
            listViewGroup.get(i).setFocusable(true);
            listViewGroup.get(i).setFocusableInTouchMode(true);
            listViewGroup.get(i).setFocusable(true);
            listViewGroup.get(i).setFocusableInTouchMode(true);
            listViewGroup.get(i).requestFocus();
            listViewGroup.get(i).setOnTouchListener(new View.OnTouchListener() {
