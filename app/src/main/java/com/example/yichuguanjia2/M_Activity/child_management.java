...
public class child_management extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.child_manage);
        ImageView add = findViewById(R.id.clothes_add);
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { new BottomSheet.Builder(com.example.yichuguanjia2.M_Activity.child_management.this).title("请选择").sheet(R.menu.choose_item).listener(new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    switch (i) {
                        ...
                        case R.id.add_camera:
                            ...
                            break;
                        case R.id.add_pic:
                            Toast.makeText(com.example.yichuguanjia2.M_Activity.child_management.this, "添加图片", Toast.LENGTH_SHORT).show();
                            if (ActivityCompat.checkSelfPermission(com.example.yichuguanjia2.M_Activity.child_management.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                                ActivityCompat.requestPermissions(com.example.yichuguanjia2.M_Activity.child_management.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                            }
       ...
       /*
        ...
        gridView1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                if (position == 0) { //点击图片位置为+ 0对应0张图片
                    ...
                    intent.setClass(com.example.yichuguanjia2.M_Activity.child_management.this, ImgFileListActivity.class);
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                Bitmap bm;
                bm = getBitmapFromUri(com.example.yichuguanjia2.M_Activity.child_management.this, getImageContentUri(com.example.yichuguanjia2.M_Activity.child_management.this, path));
        ...
        if (listfile.size()!=0 || mCameraUri!=null || !TextUtils.isEmpty(pathImage) || saveCode == 9) {
            ...
            if(resumeCode == 3){
                for(int i=0;i<listfile.size();i++) {
                    ...
                    values.clear();
                    bm = getBitmapFromUri(com.example.yichuguanjia2.M_Activity.child_management.this, getImageContentUri(com.example.yichuguanjia2.M_Activity.child_management.this, listfile.get(i)));
                    HashMap<String, Object> map = new HashMap<String, Object>();
                ...
                db.insert(tableName+version,null,values);
                values.clear();
                bm = getBitmapFromUri(com.example.yichuguanjia2.M_Activity.child_management.this, getImageContentUri(com.example.yichuguanjia2.M_Activity.child_management.this,pathImage));
                map.put("itemImage", bm);
                imageItem.add(map);
            } else {
                HashMap<String, Object> map = new HashMap<String, Object>();
                values.put("path",getPathFromUri(this,mCameraUri));
                db.insert(tableName+version,null,values);
                values.clear();
                bm = getBitmapFromUri(com.example.yichuguanjia2.M_Activity.child_management.this, mCameraUri);
                map.put("itemImage", bm);
                imageItem.add(map);
            }
            resumeCode = 0;
    ...
    protected void dialog(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(com.example.yichuguanjia2.M_Activity.child_management.this);
